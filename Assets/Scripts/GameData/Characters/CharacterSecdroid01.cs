...
public class CharacterSecdroid01 : Character {
    ...
    protected override void OnDeath() {
        ...
        EffectManager.CreateEffect("effect_character_secdroid01_death", transform.position, 0, null, !IsFacingRight());
        EffectManager.CreateEffect("effect_character_secdroid01_explosion", transform.position, 0, null, !IsFacingRight());
        base.OnDeath();
    }
